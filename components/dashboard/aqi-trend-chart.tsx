...
export function AQITrendChart({ data = [], selectedPollutant = "ALL" }: AQITrendChartProps) {
  ...
  // Format active pollutant label for header legend
  const pollutantLabel = selectedPollutant === "ALL" ? "AQI Level" : `${selectedPollutant} Level`
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground font-medium">{pollutantLabel}</span>
          </div>
        </div>
      </div>
